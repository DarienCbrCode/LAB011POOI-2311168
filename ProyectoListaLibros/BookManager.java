...
public class BookManager {
    ...
    public void displayMenu() {
        ...
        System.out.println("e. Buscar un libro por título.");
   ...
   public void removeBook() {
    ...
    showBookList(); // Mostrar la lista antes de la eliminación
    ...
    showBookList(); // Mostrar la lista después de la eliminación
}
    ...
    showBookList(); // Mostrar la lista antes de la edición
    ...
    showBookList(); // Mostrar la lista después de la edición
}
public void searchBookByTitle() {
    ...
    for (Book book : books) {
        if (book.getName().equalsIgnoreCase(titleToSearch)) {
            ...
            found = true;
            break; // Detener la búsqueda después de encontrar el primer libro con el título dado
        }
    }
}
